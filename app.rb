...
Product.new(title: "LEGO Iron Man vs. Ultron", price: 22.99, stock: 55) # Should return DuplicateProductError: 'LEGO Iron Man vs. Ultron' already exists.
...
Customer.new(name: "Walter Latimer") # Should return DuplicateCustomerError: 'Walter Latimer' already exists.
...
puts "New feature 1 loyalty points calculation: #{walter.loyalty_points}"
...
puts "New feature 1 loyalty points :#{walter.loyalty_points}"
...
walter.purchase(firehouse) # Should return OutOfStockError: 'LEGO Firehouse Headquarter' is out of stock.
